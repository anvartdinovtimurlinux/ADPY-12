...
Тест запускается командой `python3 -m unittest tests/test_secretary.py`
...
Тест запускается командой `python3 -m unittest tests/test_yandex_translate.py`

### Задача №3. Дополнительная (не обязательная)
Применив selenium напишите unit-test для авторизации на Яндексе по url: https://passport.yandex.ru/auth/

Тест запускается командой `python3 -m unittest tests/test_selenium.py`
